...
1) Run `./gradlew :volvo-api-client:publishToMavenLocal`
2) Open `~/.m2/repository/com/github/ayastrebov/volvo/client/"}`
...
4) Add the secrets to `local.properties`:
   ...
   ```
5) Run `./gradlew :volvo-api-client:publishAllPublicationsToSonatypeRepository`
